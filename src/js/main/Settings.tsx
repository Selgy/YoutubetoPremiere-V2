...
const Settings = ({ onBack }: SettingsProps) => {
  ...
  const playTestSound = async () => {
    ...
    try {
      const response = await fetch(`http://${serverIP}:17845/test-sound`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  useEffect(() => {
    ...
    fetch(`http://${serverIP}:17845/available-sounds`)
  ...
  const openLogsFolder = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://${serverIP}:17845/open-logs-folder`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        }
  ...
  const openSoundsFolder = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://${serverIP}:17845/open-sounds-folder`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        }
